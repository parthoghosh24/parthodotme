...
export const experiencesData = [
  {
    title: "Senior Applications Developer (Contract)",
    location: "Telus Health - Calgary, AB, CA",
    description:
  ...
  },
  {
    ...
    description:
      ...
      Contributed in push notification implementation using RoR, React native, Firebase and AWS.
